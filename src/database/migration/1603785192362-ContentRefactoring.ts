...
export class ContentRefactoring1603785192362 implements MigrationInterface {
    name = 'ContentRefactoring1603785192362';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            "CREATE TABLE `content_comments` (`id` varchar(36) NOT NULL, `body` varchar(255) NOT NULL COMMENT '评论内容', `nsleft` int NOT NULL DEFAULT 1, `nsright` int NOT NULL DEFAULT 2, `parentId` varchar(36) NULL, `articleId` varchar(36) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB",
        );
        await queryRunner.query(
            "CREATE TABLE `content_articles` (`id` varchar(36) NOT NULL, `title` varchar(255) NOT NULL COMMENT '文章标题', `body` longtext NOT NULL COMMENT '文章内容', `description` varchar(255) NULL COMMENT '文章描述', `keywords` text NULL COMMENT '关键字', `isPublished` tinyint NOT NULL COMMENT '是否发布' DEFAULT 0, `published_at` varchar(255) NULL COMMENT '发布时间', `created_at` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB",
        );
        await queryRunner.query(
